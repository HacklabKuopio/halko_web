    ...
    <section id="membership" className="py-24 relative">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="font-display text-4xl font-bold text-foreground mt-2 mb-4">{title}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto mb-12">
          {membershipTypes?.map((type) => (
            ...
            >
              ...
              <h3 className="font-display text-xl font-bold text-foreground mb-2">{type.title}</h3>
        ...
        <div className="bg-card border border-border p-8 rounded-lg max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground text-sm mt-6 mb-4">{paymentInstruction}</p>

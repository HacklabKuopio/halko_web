...
const ContactSection = (props: ContactSectionBlock) => {
  const { subtitle, title, links, sponsorsSubtitle, sponsorsTitle, sponsorsText, sponsorLink } =
    props

  const hasSponsorLink = sponsorLink && (sponsorLink.url || sponsorLink.reference)
  const sponsorLinkProps = hasSponsorLink
    ? sponsorLink
    : {
        type: 'custom',
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <h2 className="font-display text-4xl font-bold text-foreground mt-2 mb-8">{title}</h2>
          ...
          <div id="sponsors">
            ...
            <div className="bg-card border border-border p-8 rounded-lg text-center">
              <p className="text-muted-foreground mb-6">{sponsorsText}</p>
              <CMSLink
